...
class ThemeTests(unittest.TestCase):
    ...
    def test_current_applied_appearance_is_captured_and_round_trips(self):
        ...
        values={
            ...
            ("io.github.gnomecustomizer.shell","folder-tile-transparency-enabled"):True,("io.github.gnomecustomizer.shell","folder-tile-opacity"):0.0,("io.github.gnomecustomizer.shell","folder-dialog-transparency-enabled"):True,("io.github.gnomecustomizer.shell","folder-dialog-opacity"):0.55,
