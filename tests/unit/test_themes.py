...
class ThemeTests(unittest.TestCase):
    ...
    def test_current_applied_appearance_is_captured_and_round_trips(self):
        ...
        values={
            ...
            ("org.freedesktop.UPower.PowerProfiles","active-profile"):"performance",
            ...
            ("io.github.gnomecustomizer.shell","folder-tile-transparency-enabled"):True,("io.github.gnomecustomizer.shell","folder-tile-opacity"):0.0,("io.github.gnomecustomizer.shell","folder-dialog-transparency-enabled"):True,("io.github.gnomecustomizer.shell","folder-dialog-opacity"):0.55,("io.github.gnomecustomizer.shell","folder-brightness"):0.9,
        ...
        self.assertTrue(manifest["shell"]["overview"]["folder_tile_enabled"]);self.assertEqual(manifest["shell"]["overview"]["folder_tile_opacity"],0)
        self.assertTrue(manifest["shell"]["overview"]["folder_dialog_enabled"]);self.assertEqual(manifest["shell"]["overview"]["folder_dialog_opacity"],.55)
        self.assertEqual(manifest["shell"]["overview"]["folder_brightness"],.9)
