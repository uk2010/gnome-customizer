...
class CustomizerApplication(Adw.Application):
    ...
    def _about(self,*_):
        dialog=Adw.AboutDialog(application_name="GNOME Customizer",application_icon=APP_ID,developer_name="GNOME Customizer Contributors",version="0.3.20",website="https://github.com/uk2010/gnome-customizer",issue_url="https://github.com/uk2010/gnome-customizer/issues",license_type=Gtk.License.GPL_3_0);dialog.present(self.props.active_window)
